...
export default function AIChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: 'أهلاً بيك في سفير العطور 🌹 ازاي أقدر أساعدك؟',
      isUser: false,
      timestamp: new Date()
    }
  ]);
...
- زر عرض المنتج الذي يحتوي على الرابط يكون اسفل النبذه عن المنتج بحيث اذا كان هناك اكثر من منتج مقترح يكون زر عرض المنتج اسفل كل نبذة على حدى 
- **شجع العميل على طرح المزيد من الأسئلة إذا أراد تفاصيل إضافية بقول "لو حابب تفاصيل أكتر، أنا موجود يا فندم."**
- عند اقتراح منتج، اذكر اسمه مع نبذة خفيفة جدًا. **يجب أن يكون الرابط في نهاية النبذة المختصرة لكل منتج.
...
- لا تذكر رقم الواتساب أو معلومات تواصل
