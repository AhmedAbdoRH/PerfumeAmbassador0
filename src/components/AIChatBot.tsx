                                ...
                                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex justify-start">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className="bg-white/10 rounded-2xl px-3 py-2 border border-white/20">
                                            ...
                                            <div className="w-1 h-1 bg-white/60 rounded-full animate-bounce mx-1"></div>
                                           <div className="w-1 h-1 bg-white/60 rounded-full animate-bounce mx-1" style={{ animationDelay: '0.2s' }}></div>
                                           <div className="w-1 h-1 bg-white/60 rounded-full animate-bounce mx-1" style={{ animationDelay: '0.4s' }}></div>
                                          </div>
